...
module.exports.renderEditForm = async function (req, res) {
    ...
    // if they aren't staff, and they aren't the student whose profile they are trying to edit, redirect
    if (!isAdmin && !profileBelongsToUser) {
        res.redirect('/')
        return
    }
...
module.exports.updateStudent = async function (req, res) {
    ...
    // if they aren't staff, and they aren't the student whose profile they are trying to update, redirect
    if (!isAdmin && !profileBelongsToUser) {
        res.redirect('/')
        return
    }
...
module.exports.enrollStudent = async function (req, res) {
    ...
    // if they aren't staff and they aren't the student who they are trying to enroll, redirect
    if (!isAdmin && !profileBelongsToUser) {
        res.redirect('/')
        return
    }
...
module.exports.removeCourse = async function(req, res){
    ...
    // if they aren't staff and they aren't the student who they are trying to drop, redirect
    if (!isAdmin && !profileBelongsToUser) {
        res.redirect('/')
        return
    }
